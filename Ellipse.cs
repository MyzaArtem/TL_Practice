...
namespace TL1
{
    public class Ellipse
    {
        ...
        public Ellipse(Point centralPoint, int semiMinorAxis, int semiMajorAxis)
        {
            ...
            if (semiMinorAxis <= 0)
            {
                throw new ArgumentException("The minor semi-axis cannot be less than or equal to 0 ");
            }

            if (semiMajorAxis <= 0)
            {
                throw new ArgumentException(" The Major semi-axis cannot be less than or equal to 0 ");
            }
